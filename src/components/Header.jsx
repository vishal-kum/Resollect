...
const Header = () => {
  ...
  return (
    <div className="w-full bg-white p-2 shadow flex justify-between items-center fixed z-10">
      {/* Logo */}
      <h1 className="text-xl font-bold text-blue-700">Resollect</h1>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          ...
          <div className="text-gray-700 text-left">
            ...
            <p className="text-sm text-gray-500">tushar@resollect.com</p>
          </div>
        ...
        {isOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md overflow-hidden border border-gray-200">
            <ul className="text-gray-700">
              ...
              <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer border-t">Logout</li>
            </ul>
          </div>
        )}
      </div>
